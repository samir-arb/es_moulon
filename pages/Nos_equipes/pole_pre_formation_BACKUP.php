...
$sql = "
    ...
    WHERE c.name IN ('U12', 'U13', 'U14', 'U15')
...
<style>
  * {
  ...
  /* Barre verte décorative en haut */
  ...
  /* Badge RESPONSABLE au-dessus de la photo */
  .responsable-header.option4 .responsable-photo-wrapper::before {
    content: 'RESPONSABLE';
    position: absolute;
    top: -15px;
    left: 50%;
  ...
  /* Message d'introduction compact */
  ...
  <!-- HEADER RESPONSABLE -->
  <!-- 🎨 Pour changer de design, modifiez la classe :
       - option1 = Gradient moderne
       - option2 = Carte élégante
       - option3 = Héro moderne
       - option4 = Design Pro Club ⭐ (RECOMMANDÉ)
  -->
  ...
  <div class="responsable-inner">
    ...
    <div class="responsable-text">
      <p class="responsable-quote">
        "Le pôle préformation de l’ES Moulon s’adresse aux jeunes joueurs de 11 à 14 ans (catégories U12 à U15). À cette étape clé du développement, notre ambition est d’accompagner chaque joueur dans sa progression technique, tactique, physique… mais aussi humaine.
        Nous structurons nos séances autour d’un travail rigoureux sur les fondamentaux du jeu : placement, déplacements, intelligence de jeu, maîtrise technique. Le passage au football à 8 puis à 11 représente une transition importante, que nous préparons avec attention pour que chaque jeune prenne plaisir à progresser et à se dépasser."

      </p>

      <p class="responsable-quote">
        "Encadrés par des éducateurs formés et passionnés, les jeunes bénéficient de deux à trois séances hebdomadaires, ainsi que de matchs compétitifs le week-end.
        Le pôle préformation est plus qu’un passage : c’est une phase essentielle dans la construction du joueur... et de la personne."
      </p>
