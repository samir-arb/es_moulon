...
<head>
    ...
    <title><?= $title ?></title>
    <meta name="description" content="<?= htmlspecialchars(substr($article['content'], 0, 160)) ?>">
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        @media print {
            .breadcrumb, .btn-back, .sidebar, .share-buttons {
...
<body>
    ...
    <div class="container">
        ...
        <div class="breadcrumb">
            ...
            <span>›</span>
            <a href="<?= url('?page=actualites') ?>">Actualités</a>
            <span>›</span>
