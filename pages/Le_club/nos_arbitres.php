...
<style>
    ...
    .testimonial {
        background: linear-gradient(135deg, #007a3d, #009639);
        color: var(--white);
        padding: 40px;
        border-radius: 20px;
        text-align: center;
...
<section class="hero-history">
    <h1> Nos arbitres  </h1>
    <p>Les gardiens de l'équité, les garants du fair-play.<br>
            Découvrez les hommes et femmes qui font vivre les valeurs du football à l' ES Moulon.</p>
</section>
    ...
    <div class="container">
        <div class="become-content">
            ...
            <div class="testimonial">
                ...
                <p class="testimonial-author">— Kevin, arbitre ES Moulon depuis 2022</p>
            </div>
