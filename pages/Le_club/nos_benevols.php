...
<head>
    ...
    <title>Nos Bénévoles - ES Moulon</title>
...
<body>
    ...
    <!-- HERO SECTION -->
    <section class="hero-benevoles">
        <div class="hero-content">
            <div class="heart-icon">💚</div>
            <h1>Nos Bénévoles</h1>
            <p class="subtitle">
                Le cœur battant de l'ES Moulon. Sans eux, rien ne serait possible. 
                Découvrez l'engagement extraordinaire qui fait vivre notre club jour après jour.
            </p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="testimonials-container">
                <div class="testimonial">
                    ...
                    <p class="testimonial-author">— Marie, bénévole depuis 2018</p>
                </div>
                ...
                <div class="testimonial">
                    ...
                    <p class="testimonial-author">— Patrick, bénévole et trésorier</p>
                </div>
            </div>
        </div>
    </section>
